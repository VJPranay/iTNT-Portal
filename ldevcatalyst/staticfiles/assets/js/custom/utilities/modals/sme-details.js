...
var KTModalNewAddress = function () {
    ...
    var fetchsmeDetails = function(smeId) {
        ...
        const options = {
            ...
            .then(data => {
                ...
                document.getElementById('sme_profile_data').innerHTML = data.html;
            })
            .catch(error => {
    ...
    return {
        ...
        init: function () {
            ...
            modalEl.addEventListener('show.bs.modal', function (event) {
                // Get the sme ID from the data attribute
                var anchorTag = event.relatedTarget;
                var smeId = anchorTag.getAttribute('data-sme-id');

                // Make a POST request to fetch sme details
                fetchsmeDetails(smeId);
                console.log(smeId);
            });
        }
    };
