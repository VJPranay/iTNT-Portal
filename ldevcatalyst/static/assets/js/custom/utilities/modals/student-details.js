...
var KTModalNewAddress = function () {
    ...
    var fetchstudentDetails = function(studentId) {
        ...
        const options = {
            ...
            .then(data => {
                ...
                document.getElementById('student_profile_data').innerHTML = data.html;
            })
            .catch(error => {
    ...
    return {
        ...
        init: function () {
            ...
            modalEl.addEventListener('show.bs.modal', function (event) {
                ...
                var studentId = anchorTag.getAttribute('data-student-id');

                // Make a POST request to fetch student details
