...
var KTModalNewAddress = function () {
    ...
    var fetchVCDetails = function(VCId) {
        ...
        const options = {
            ...
            .then(data => {
                ...
                document.getElementById('VC_profile_data').innerHTML = data.html;
            })
            .catch(error => {
    ...
    return {
        ...
        init: function () {
            ...
            modalEl.addEventListener('show.bs.modal', function (event) {
                // Get the VC ID from the data attribute
                var anchorTag = event.relatedTarget;
                var VCId = anchorTag.getAttribute('data-VC-id');

                // Make a POST request to fetch VC details
                fetchVCDetails(VCId);
            });
        }
    };
