...
class RollsRoyceProposal(models.Model):
    ...
    proposed_rc_research_papers_exist = models.CharField(max_length=3, choices=[('Yes', 'Yes'), ('No', 'No')])
    proposed_rc_research_papers_count = models.IntegerField(null=True, blank=True)
    proposed_rc_research_papers_links = models.TextField(null=True, blank=True)
    proposed_rc_research_papers_files = models.FileField(upload_to='proposed_rc_research_papers/', null=True, blank=True)
