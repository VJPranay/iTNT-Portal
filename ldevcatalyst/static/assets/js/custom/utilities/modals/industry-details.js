...
var KTModalNewAddress = function () {
    ...
    var fetchindustryDetails = function(industryId) {
        ...
        fetch(fetchUrl, options)
            ...
            .then(data => {
                ...
                document.getElementById('industry_profile_data').innerHTML = data.html;
            })
            .catch(error => {
    ...
    return {
        ...
        init: function () {
            ...
            modalEl.addEventListener('show.bs.modal', function (event) {
                // Get the industry ID from the data attribute
                var anchorTag = event.relatedTarget;
                var industryId = anchorTag.getAttribute('data-industry-id');

                // Make a POST request to fetch industry details
