...
class HackathonProposalAdmin(admin.ModelAdmin):
    ...
    def export_as_pdf(self, request, queryset):
        ...
        elements = [Paragraph("Hackathon Proposal Data", styles['CustomTitle'])]
        fields_to_display = [
            ('user', 'User'),
            ...
            ('proposed_hackathon_research_papers_exist', 'Research Papers Exist'),
            ('proposed_hackathon_research_papers_count', 'Research Papers Count'),
            ('proposed_hackathon_research_papers_links', 'Research Papers Links'),
            ('timeframe', 'Timeframe'),
        ...
        for obj in queryset:
            for field_path, field_display in fields_to_display:
                ...
                if field_path == 'proposed_hackathon_research_papers_links' and field_value != 'N/A':
        ...
        response['Content-Disposition'] = 'attachment; filename="Hackathon_Proposals.pdf"'
...
admin.site.register(HackathonProposal, HackathonProposalAdmin)
